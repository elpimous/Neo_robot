...
class mediaPlayer():
  ...
  def __init__(self):
        ...
        rospy.Subscriber('hand_detector', String, self.hand_detector)
  ...
  def hand_detector(self, msg):
      self.iSeeYourHand = msg.data

  def Cut_mics(self):
          runCmd("amixer -c 1 sset Mic,1 nocap")
