...
#initialize node
    ...
    self.angularCoeff = .11 # with this value, angular speed changes with distance, test with slow changes
    self.linearCoeff = 0.13 # idem, but with linear speed
...
#****************** AVOIDING BACK-FALLING *****************************
    ...
    if not self.floorDistanceOk or not self.wallDistanceOk or not self.imuAngleOk :
...
#****************** NO OBSTACLES / FULL SPEED  ************************OK
      ...
      if self.frontRightDistance == 3 and self.frontLeftDistance == 3:
