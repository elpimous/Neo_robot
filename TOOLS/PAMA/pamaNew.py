...
def vp_start_gui():
    ...
    global val, w, root
    root = Tk()
    root.title('Pocketsphinx_Acoustic_Model_Adaptation -- ver.3.00 --                     elpimous12@orange.fr  ')
    geom = "786x450"
    root.geometry(geom)
...
class Pocketsphinx_Acoustic_Model_Adaptation:
	...
	self.SPEECH_DURATION = 300 # end recording if too much input
        ...
        self.i = 1 # sentence 443
        self.val = 0 # lign in textfile
...
# about popup
    ...
    def REC(self):
      if self.notext == False:
        ...
        self.Button1.configure(image=self.recB, command=self.stop)
        root.update()
        self.text_popup()
        self.rec = Recorder()
        with self.rec.open(self.racine+"/adapt"+str(self.i)+".wav", 'wb') as self.recfile2:
    ...
    def stop(self):
        ...
        self.Button1.configure(image=self.recB11, command=self.REC)
        root.update()
        self.recfile2.close()
...
#°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
    ...
    def auto_mode(self):
      if self.automode == True:
        ...
        self.sentence = (self.Sentences[self.val])
        if self.sentence == "\n":
            self.auto_mode()
